  ...
  <div class="app-container">
    <el-card>
      <div style="width: 100%" class="cc-mar-b-10">
        <el-input v-model="form.name" style="width: 200px" placeholder="角色名称" />
      ...
      <c-super-table ref="myTable" :table-interface="tableInter" :options="optionData">
        ...
        <el-table-column width="260" slot="temp_action" label="状态">
          <template slot-scope="{ row }" >
            <el-button size="mini">修改</el-button>
            <el-button type="danger" size="mini">删除</el-button>
            <el-button type="primary" size="mini">权限配置</el-button>
          </template>
        </el-table-column>
      </c-super-table>
    </el-card>
    ...
    return {
      ...
      optionData: {
        ...
        tableHeader: [
          ...
          { label: '名称', prop: 'account' },
          { label: '上级角色', prop: 'name' },
          { label: '别名', prop: 'department' },
