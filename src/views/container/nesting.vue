...
<template>
  <div class="cc-contriner">
    <c-container :l-width="128" :r-width="230">
      <div slot="header">基本容器头</div>
      <div slot="left" >
      ...
      <div slot="right">
        <div class="c-right-control">
          <div
            v-for="item in iconList"
            :key="item.id"
            :span="8"
            class="cc-mar-t-10 c-item">
            <el-link :underline="false"><i :class="[item['icon']]" class=" cc-f-s30"/></el-link>
          </div>
        </div>
      </div>
      <div slot="footer">基本容器底</div>
      <div class="cc-pad-10">
        <c-container ref="contain2" :l-width="128" :r-width="230">
          <div slot="header">基本容器头</div>
          <div slot="left" >
            <el-tabs :tab-position="tabPosition" style="height: 100%;">
              <el-tab-pane
          ...
          <div class="cc-pad-10">
            ...
            <div>
              ...
              <p>
                <strong>可控</strong> Controllability
              </p>
              <ul>
                <li>
...
import { getCommonContainerList } from '@/api/modules/common.js'
  export default {
    ...
    mounted() {
      ...
      setTimeout(() => {
        // this.$refs['contain3'].update()
        this.$nextTick(this.$refs['contain2'].update)
      }, 300);
    }
  }
</script>
